...
class Meeting(Base):
    ...
    公告日期 = Column(DateTime, nullable=False, index=True)
    股东大会名称 = Column(Text)
    会议召开日期 = Column(DateTime, nullable=False, index=True)
    股东大会类别 = Column(Text)
    A股股权登记日期 = Column(DateTime, nullable=False, index=True)
    网络投票起始日 = Column(DateTime, nullable=False, index=True)
    网络投票终止日 = Column(DateTime, nullable=False, index=True)
    会议召开地点 = Column(Text)
    是否取消 = Column(Text)
    取消公告日期 = Column(DateTime, nullable=False, index=True)
    参会登记日期截止日期 = Column(DateTime, nullable=False, index=True)
    交易系统投票日期 = Column(DateTime, nullable=False, index=True)
