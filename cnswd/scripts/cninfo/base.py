...
DB_DATE_FIELD = {
    ...
    '2.3':   ('截止日期',       '2004-11-29'),
    '2.4':   ('增_减持截止日',   '2006-09-30'),
    '2.5':   ('截止日期',        '1997-06-30'),
    '3.1':   ('交易日期',        default_start_date),
    '4.1':   ('发布日期',        '2003-01-02'),
    '5.1':   ('报告年度',        default_start_date),
...
TS_DATE_FIELD = {
    ...
    # 3 股东股本
    '3.1':      ('实际解除限售日期', default_start_date),
    '3.2':      ('公告日期', default_start_date),
    '3.3':      ('公告日期', default_start_date),
    # '3.4':      ('公告日期', '2007-09-12'),
    # '3.5':      ('公告日期', '2007-09-12'),
    '3.6':      (None, None),
