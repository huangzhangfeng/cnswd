...
DATE_MAPS = {
    ...
    '12.2':    (None, None),
    '12.3':    (None, None),
    '13.1':    ('公告日期', 'B', '2012-02-01'),
    '13.2':    ('公告日期', 'B', '2009-08-19'),
    '13.3':    ('公告日期', 'B', '2001-07-20'),
    '13.4':    ('公告日期', 'B', '1998-10-29'),
    '13.5':    ('公告日期', 'B', '1999-08-27'),
    '13.6':    ('公告日期', 'B', '1999-07-28'),
    '13.7':    ('公告日期', 'B', '1998-08-05'),
    '14.1':    ('变动日期', 'B', '2009-10-30'),
    '15.1':    ('净值日期', 'B', '2012-01-03'),
    '16.1':    ('发布日期', 'B', '2003-01-02'),
}
