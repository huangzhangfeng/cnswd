...
from cnswd.websource._selenium import make_headless_browser_with_auto_save_path

EARLIEST_POSSIBLE_DATE = pd.Timestamp('2002-1-4', tz='UTC')

DB_COLS_NAME = [
    'm0', 'm1', 'm2', 'm3', 'm6', 'm9', 'y1', 'y3', 'y5', 'y7', 'y10', 'y15', 'y20', 'y30', 'y40', 'y50'
]
DB_INDEX_NAME = 'date'

OUTPUT_COLS_NAME = [
    '0month', '1month', '2month', '3month', '6month', '9month', '1year', '3year', '5year', '7year',
    '10year', '15year', '20year', '30year', '40year', '50year'
]
...
def _preprocess(df, start, end):
    ...
    labels = [0, 0.08, 0.17, 0.25, 0.5, 0.75, 1, 3,
...
def fetch_treasury_data_from(start=EARLIEST_POSSIBLE_DATE.date(), end=pd.Timestamp('today')):
    """
    获取期间资金成本数据
